...
[_LAYERS] = {
  ...
  {_______, _______, _______, _______, _______, _______, _______, TO(_BASE), TO(_MOVE), TO(_SYMB), TO(_MOUSE), _______},
  {_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______},
  {_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______}
},
 ...
 */
[_BASE] = {
  { LT(_LAYERS, KC_ESC),  SV_AE,   KC_Q,   KC_DOT,  KC_COMM,  KC_Y,    KC_F,    KC_G,    KC_L,    KC_H,    KC_M,    KC_BSPC },
 ...
 */
[_SYMB] = {
  { _______, KC_TILD, KC_EXLM    ,KC_LCBR, KC_RCBR ,KC_HASH, _______, KC_7,    KC_8,    KC_9, KC_MINS, _______},
 ...
 */
[_FUNC] = {
  {_______,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    ENDASH },
 ...
 */
[_MOUSE] = {
  {_______, XXXXXXX, KC_ACL2, KC_ACL1, KC_ACL0, XXXXXXX, XXXXXXX, KC_WH_L, KC_MS_U, KC_WH_R, KC_WH_U, XXXXXXX},
