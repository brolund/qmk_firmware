...
[_PARENS] = {
  ...
  {KC_DEL , _______, _______, _______, _______, _______, KC_PIPE, KC_LPRN, KC_RPRN,       LSFT(KC_LBRC), LSFT(KC_RBRC), _______},
  {_______, _______, _______, _______, _______, _______, _______, KC_LBRC, KC_RBRC,       LSFT(KC_COMM), LSFT(KC_DOT),  _______},
